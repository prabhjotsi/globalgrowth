...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ url('/admin/testimonials/create') }}" class="btn btn-success btn-sm" title="Add New TeamMember">
                        <i class="fa fa-plus" aria-hidden="true"></i> {{__('Add New')}}
                    </a>

                    <form method="GET" action="{{ url('/admin/testimonials') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('/admin/testimonials/' . $item->id . '/edit') }}" title="Edit Testimonial" ><i class="fas fa-edit text-secondary" ></i></a>

                                        <form method="POST" action="{{ url('/admin/testimonials' . '/' . $item->id) }}" accept-charset="UTF-8" class="del-btn">
                                            {{ method_field('DELETE') }}
                                            {{ csrf_field() }}
