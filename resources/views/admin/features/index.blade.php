                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('/admin/features/' . $item->id . '/edit') }}" title="Edit Feature"><i class="fas fa-edit text-secondary"></i></a>

                                        <form method="POST" action="{{ url('/admin/features' . '/' . $item->id) }}" accept-charset="UTF-8" class="del-btn">
                                            {{ method_field('DELETE') }}
                                            {{ csrf_field() }}
                                            <button type="submit" class="btn btn-link text-danger p-0 del-trash" title="Delete Feature" onclick="return confirm(&quot;Confirm delete?&quot;)"><i class="fas fa-trash-alt"></i> </button>
                                        </form>
                                    </td>
                                </tr>
                                @endforeach
